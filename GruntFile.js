...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        concat: {
            ...
            jqprogresstimer:{
                src: [
                    bowerDir + 'jquery-progresstimer/dist/js/jquery.progresstimer.js'
                ],
        ...
        uglify: {
            js: {
                files: [
                    ...
                    {
                        src: '<%= concat.jqprogresstimer.dest %>',
    ...
    grunt.registerTask('dev-js', ['newer:jshint:myFiles', 'newer:concat:staticjs', 'newer:concat:js', 'newer:concat:jqprogresstimer', 'newer:uglify:js']);

    grunt.registerTask('dist-js', ['jshint:myFiles', 'concat:staticjs', 'concat:js', 'concat:jqprogresstimer', 'uglify:js']);
